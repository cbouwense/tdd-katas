...
describe("Add", () => {
    ...
    describe("when there is a separator at the end of the input", () => {
        it("should throw an error", () => {
            expect(() => Add(",")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
            expect(() => Add("\n")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
            expect(() => Add("0,")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
            expect(() => Add("0\n")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
            expect(() => Add("0,1,")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
            expect(() => Add("0,1\n")).toThrow(INPUT_ENDS_WITH_SEPARATOR_ERROR_MESSAGE);
        })
    });
